    ...
    $.ajax({
        ...
        success:function(responsedata){
          ...
          $.each(data, function (i,data1) {
            text +="<div><img src='https://plivo1.demo.xmagestore.com/shopify_shoes_app/uploads/"+data1.image+"' /><p style='position: absolute;top: 60%;left: 20%;font-weight: bold; text-align:center; right:20%;color: white;font-size: xx-large;'>"+data1.name+"</p></div>";
          });
